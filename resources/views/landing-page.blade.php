...
<div class="grid w-full h-screen grid-cols-5 p-5 bg-gradient-to-br from-indigo-500 to-purple-900" x-data="{profile:false}">
    ...
    <div class="fixed inset-0 z-30 flex items-center justify-center w-full h-full bg-black/80" x-transition x-show="profile">
        <div class="flex flex-col w-1/2 px-8 py-4 bg-white rounded-lg">
