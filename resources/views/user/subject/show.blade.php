                ...
                @if ($subject->quiz_id)
                    <div class="min-w-0 p-4 bg-purple-600 rounded-lg shadow-lg dark:bg-gray-800">
                        ...
                        @if ($answer)
                            ...
                            <a href="{{ $answer->file }}" class="flex flex-col w-1/2 px-3 py-2 mt-auto transition-all bg-white border rounded-md md:w-1/6 group hover:bg-slate-600 border-slate-600">
